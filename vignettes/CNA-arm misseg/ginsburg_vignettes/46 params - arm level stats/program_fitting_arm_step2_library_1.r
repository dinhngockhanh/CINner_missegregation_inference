...
list_parameters[nrow(list_parameters) + 1, ] <- c(
    "10^:prob_CN_arm_missegregation", "log10(prob_arm_misseg)", NA, "CNA_probability",
...
list_chromosome_arms <- paste(unique(model_variables$chromosome_arm_library$Arm_ID), collapse = ",")
...
list_targets_library <- c(
    ...
    paste0("data=bulk;target=chromosome_arm;statistic=dist;variable=average_CN;metric=euclidean;chromosome_arm=", list_chromosome_arms),
    paste0("data=bulk;target=chromosome_arm;statistic=mean;representative_CN=average_CN;variable=event_count;type=total;event=chromosome-arm-missegregation;chromosome_arm=", list_chromosome_arms),
    paste0("data=bulk;target=chromosome_arm;statistic=var;representative_CN=average_CN;variable=event_count;type=total;event=missegregation;chromosome_arm=", list_chromosome_arms),
    ...
    paste0("data=sc;target=chromosome_arm;statistic=dist;variable=clonal_CN;metric=euclidean;chromosome_arm=", list_chromosome_arms),
    paste0("data=sc;target=chromosome_arm;statistic=mean;variable=shannon;chromosome_arm=", list_chromosome_arms),
    paste0("data=sc;target=chromosome_arm;statistic=mean;variable=event_count;type=clonal;event=chromosome-arm-missegregation;chromosome_arm=", list_chromosome_arms),
    paste0("data=sc;target=chromosome_arm;statistic=mean;variable=event_count;type=subclonal;event=chromosome-arm-missegregation;chromosome_arm=", list_chromosome_arms),
    paste0("data=sc;target=chromosome_arm;statistic=var;variable=shannon;chromosome_arm=", list_chromosome_arms),
    paste0("data=sc;target=chromosome_arm;statistic=var;variable=event_count;type=clonal;event=chromosome-arm-missegregation;chromosome_arm=", list_chromosome_arms),
    paste0("data=sc;target=chromosome_arm;statistic=var;variable=event_count;type=subclonal;event=chromosome-arm-missegregation;chromosome_arm=", list_chromosome_arms),
...
#---Statistics for fitting arm_misseg rate
list_targets_arm_misseg <- c(
    # #---Bulk DNA: CN
    "data=bulk;target=genome;statistic=dist;variable=average_CN;metric=euclidean",
    # "data=bulk;target=genome;statistic=mean;representative_CN=average_CN;variable=event_count;type=total;event=missegregation",
    # "data=bulk;target=genome;statistic=var;representative_CN=average_CN;variable=event_count;type=total;event=missegregation",
...
list_targets[2, which(colnames(list_targets) %in% list_targets_arm_misseg)] <- 1
...
for (row in 3:nrow(list_targets)) {
